submodule ( preorb_conversion_m ) preorb_conversion_DD_s
implicit none

     contains

     ! Функция для конвертации из радианной меры в градусную
     module procedure preorb_conversion_DD
     ...
     end procedure preorb_conversion_DD

end submodule preorb_conversion_DD_s