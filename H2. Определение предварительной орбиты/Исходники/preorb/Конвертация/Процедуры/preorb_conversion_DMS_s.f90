submodule ( preorb_conversion_m ) preorb_conversion_DMS_s
implicit none

     contains

     ! Функция для конвертации из радианной меры в часовую
     module procedure preorb_conversion_DMS
     ...
     end procedure preorb_conversion_DMS

end submodule preorb_conversion_DMS_s